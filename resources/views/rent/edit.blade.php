...
@section('content')
    @include('users.partials.header', [
        ...
        'description' => __('This is your House Rent edit page. You can edit and upload your bill here.Everyone can see this bill afterward'),
        'class' => 'col-lg-7'
    ])   
                ...
                <div class="card card-profile shadow">
                    ...
                    <div class="card-body pt-0 pt-md-4">
                        ...
                        <div class="text-center">
                            <h3>
                                {{123}}<span class="font-weight-light">, {{123}}</span>
                            </h3>
                            <div class="h5 font-weight-300">
                                <i class="ni location_pin mr-2"></i>{{123}}
                            </div>
                            <div class="h5 mt-4">
                                <i class="ni business_briefcase-24 mr-2"></i>{{123}} - {{123}}
                            </div>
                            <div>
                                <i class="ni education_hat mr-2"></i>{{123}}
                            </div>
                            <hr class="my-4" />
                            <p>{{123}}</p>
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <h3 class="mb-0">{{ __('House Rent Details') }}</h3>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="post" enctype="multipart/form-data" action="{{ route('rent.update') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('Amount') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="amount" id="input-amount" class="form-control form-control-alternative{{ $errors->has('amount') ? ' is-invalid' : '' }}" placeholder="{{ __('Enter amount here') }}" value="{{ old('amount', $houseRent->amount) }}" autofocus>
                                ...
                                @endforeach
                                <div class="text-center">
                                    <button type="submit" class="btn btn-success mt-4">{{ __('Update Bill') }}</button>
                                </div>
                            </div>
                        </form>
                        <hr class="my-4" />
